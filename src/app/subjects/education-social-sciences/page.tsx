  ...
  return <main className="stack-page">
    <section className="stack-regional-hero px-6 py-16 text-white md:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="max-w-4xl text-4xl font-black tracking-tight md:text-6xl">Education & Social Sciences Academic Support</h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">Support for education, psychology and social science students. Our approach is centred on helping you understand the task, improve your own work and prepare your final submission.</p>
