...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Deakin Vancouver Referencing | Stack Assignment", url: "https://www.stackassignment.com/guides/deakin-vancouver-referencing" },
};
...
export default function GuidePage() {
  return <GuideArticle title="Deakin Vancouver Referencing Guide" eyebrow="Deakin University \u00b7 Referencing" description="A practical Vancouver-style referencing checklist for Deakin University students, especially health and science coursework." sections={sections} canonicalPath="/guides/deakin-vancouver-referencing" />;
}
