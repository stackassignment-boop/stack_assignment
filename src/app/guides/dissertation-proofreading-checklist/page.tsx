...
export default function GuidePage() {
  return <GuideArticle title="Dissertation Proofreading Checklist" eyebrow="United Kingdom \u00b7 Dissertation support" description="A practical final-pass checklist for UK university dissertations and major research projects." sections={sections} />;
}
