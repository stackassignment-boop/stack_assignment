...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Vun Turnitin | Stack Assignment", url: "https://www.stackassignment.com/guides/vun-turnitin" },
};
