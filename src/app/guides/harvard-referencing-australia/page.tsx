...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Harvard Referencing Australia | Stack Assignment", url: "https://www.stackassignment.com/guides/harvard-referencing-australia" },
};
...
export default function GuidePage() {
  return <GuideArticle title="Harvard Referencing Guide for Australian Students" eyebrow="Australia \u00b7 Referencing" description="A practical Harvard referencing checklist for Australian university essays, reports and case studies. Check your current unit guide when requirements differ." sections={sections} canonicalPath="/guides/harvard-referencing-australia" />;
}
