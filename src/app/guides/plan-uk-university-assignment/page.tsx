...
export default function GuidePage() {
  return <GuideArticle title="How to Plan a UK University Assignment" eyebrow="United Kingdom \u00b7 Assessment skills" description="A practical planning method for essays, reports and other university assessments in the UK." sections={sections} />;
}
