...
export default function GuidePage() {
  return <GuideArticle title="CQU APA Referencing Guide" eyebrow="CQUniversity \u00b7 Referencing" description="A practical APA 7 checklist for CQUniversity students preparing essays, reports and research-based assessments." sections={sections} />;
}
