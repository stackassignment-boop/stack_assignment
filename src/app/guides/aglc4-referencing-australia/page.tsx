...
export default function GuidePage() {
  return <GuideArticle title="AGLC4 Referencing Basics for Australian Students" eyebrow="Australia \u00b7 Law" description="A practical starting point for Australian law students who need to understand the Australian Guide to Legal Citation, fourth edition." sections={sections} />;
}
