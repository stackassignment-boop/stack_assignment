...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Harvard Referencing Uk | Stack Assignment", url: "https://www.stackassignment.com/guides/harvard-referencing-uk" },
};
...
export default function GuidePage() {
  return <GuideArticle title="Harvard Referencing Guide for UK Students" eyebrow="United Kingdom \u00b7 Referencing" description="A practical introduction to Harvard-style author\u2013date referencing for essays, reports and university coursework in the UK." sections={sections} canonicalPath="/guides/harvard-referencing-uk" />;
}
