...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Uwa Assignment Cover Sheet | Stack Assignment", url: "https://www.stackassignment.com/guides/uwa-assignment-cover-sheet" },
};
...
export default function GuidePage() {
  return <GuideArticle title="UWA Assignment Cover Sheet Checklist" eyebrow="UWA \u00b7 Assessment preparation" description="A practical checklist for preparing an assignment submission at the University of Western Australia. Always follow the current instructions for your unit." sections={sections} canonicalPath="/guides/uwa-assignment-cover-sheet" />;
}
