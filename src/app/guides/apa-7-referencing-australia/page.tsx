...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Apa 7 Referencing Australia | Stack Assignment", url: "https://www.stackassignment.com/guides/apa-7-referencing-australia" },
};
...
export default function GuidePage() {
  return <GuideArticle title="APA 7 Referencing Guide for Australian Students" eyebrow="Australia \u00b7 Referencing" description="A practical introduction to APA 7 for essays, reports, literature reviews and other university assessments in Australia." sections={sections} canonicalPath="/guides/apa-7-referencing-australia" />;
}
