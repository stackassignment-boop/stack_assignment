...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Torrens Marking Guide | Stack Assignment", url: "https://www.stackassignment.com/guides/torrens-marking-guide" },
};
...
export default function GuidePage() {
  return <GuideArticle title="Torrens University Assessment & Marking Guide" eyebrow="Torrens University \u00b7 Assessment planning" description="A practical guide to reading a Torrens University assessment brief and using its marking criteria to plan your own response." sections={sections} canonicalPath="/guides/torrens-marking-guide" />;
}
