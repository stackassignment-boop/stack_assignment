...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'article', modifiedTime: '2026-09-23', title: "Read Assessment Brief Australia | Stack Assignment", url: "https://www.stackassignment.com/guides/read-assessment-brief-australia" },
};
...
export default function GuidePage() {
  return <GuideArticle title="How to Read an Australian University Assessment Brief" eyebrow="Australia \u00b7 Assessment skills" description="A step-by-step method for turning an assessment brief and marking rubric into a practical writing plan." sections={sections} canonicalPath="/guides/read-assessment-brief-australia" />;
}
