  ...
  return (
    <main className="flex-grow">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-6 text-sm text-slate-500 dark:text-slate-400">
        ...
        <span className="text-slate-700 dark:text-slate-300">UniSC Assignment Support</span>
      </div>
      ...
      <section className="relative text-white py-24 md:py-36 overflow-hidden mt-6">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Link href="#unisc-courses" className="border-2 border-white/70 hover:bg-white/10 px-10 py-4 rounded-xl text-lg font-semibold transition min-w-[15rem]">Request a Quote</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-slate-950">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">Support is delivered online regardless of your UniSC campus.</p>
      ...
      <section className="py-10 bg-white dark:bg-slate-950">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-sm">
            ...
            <Link href="/universities/federation-university" className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">Federation University</Link><span className="text-slate-300 dark:text-slate-700">·</span>
