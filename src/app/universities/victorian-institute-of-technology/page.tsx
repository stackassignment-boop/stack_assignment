...
export default function VITPage() {
  return (
    <main className="flex-grow">
      ...
      <section className="relative text-white py-24 md:py-36 overflow-hidden mt-6">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Link href="#vit-courses" className="border-2 border-white/70 hover:bg-white/10 px-10 py-4 rounded-xl text-lg font-semibold transition min-w-[15rem]">View Services</Link>
          </div>
        </div>
      </section>
      ...
      <section id="vit-bits" className="py-14 bg-slate-50 dark:bg-slate-900 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm mb-3">Support across all four verified BITS specialisations:</p>
      ...
      <section id="vit-mits" className="py-14 bg-white dark:bg-slate-950 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm mb-3">Support across all four verified MITS specialisations, plus the Graduate Diploma (GDITS) and Graduate Certificate (GCITS) pathways:</p>
          <div className="grid sm:grid-cols-2 gap-2">
            {['Software Engineering', 'Business Analytics', 'Information Systems', 'Cyber Security'].map((s) => (
              <div key={s} className="flex items-center gap-2 bg-slate-50 dark:bg-slate-800 rounded-lg px-3 py-2 text-sm border border-slate-100 dark:border-slate-700"><CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0" />{s}</div>
            ))}
          </div>
        </div>
      </section>

      <section id="vit-mba" className="py-14 bg-slate-50 dark:bg-slate-900 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm mb-3">Support across all five verified MBA specialisations, plus the Graduate Diploma (GDBA) and Graduate Certificate (GCBA) of Business Administration:</p>
          <div className="grid sm:grid-cols-2 gap-2">
      ...
      <section id="vit-bbus" className="py-14 bg-white dark:bg-slate-950 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm mb-3">Support across all six verified BBus specialisations, plus the Diploma of Business (DipBus):</p>
          <div className="grid sm:grid-cols-2 gap-2">
      ...
      <section className="py-16 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-7">
            ...
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed flex items-start gap-2">
      ...
      <section className="py-16 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">Support is delivered online regardless of which VIT campus you study at.</p>
      ...
      <section className="py-10 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-sm">
            ...
            <Link href="/universities/torrens-university" className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">Torrens University</Link><span className="text-slate-300 dark:text-slate-700">·</span>
