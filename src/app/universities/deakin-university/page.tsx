  ...
  return (
    <main className="flex-grow">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-6 text-sm text-slate-500 dark:text-slate-400">
        ...
        <span className="text-slate-700 dark:text-slate-300">Deakin University Assignment Support</span>
      </div>
      ...
      <section className="relative text-white py-24 md:py-36 overflow-hidden mt-6">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Link href="#deakin-courses" className="border-2 border-white/70 hover:bg-white/10 px-10 py-4 rounded-xl text-lg font-semibold transition min-w-[15rem]">Request a Quote</Link>
          </div>
        </div>
      </section>
      ...
      <section id="deakin-it" className="py-16 bg-slate-50 dark:bg-slate-900 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              ...
              <div key={u.code} className="flex items-center gap-2 bg-white dark:bg-slate-800 rounded-lg px-3 py-2 text-sm border border-slate-100 dark:border-slate-700">
      ...
      <section className="py-16 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">Support is delivered online regardless of your Deakin campus.</p>
      ...
      <section className="py-10 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-sm">
            ...
            <Link href="/universities/la-trobe-university" className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">La Trobe University</Link><span className="text-slate-300 dark:text-slate-700">·</span>
