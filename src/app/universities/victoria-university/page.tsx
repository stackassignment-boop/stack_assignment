  ...
  return (
    <main className="flex-grow">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-6 text-sm text-slate-500 dark:text-slate-400">
        ...
        <span className="text-slate-700 dark:text-slate-300">Victoria University Assignment Support</span>
      </div>
      ...
      <section id="vu-it" className="py-16 bg-slate-50 dark:bg-slate-900 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Academic writing support for nursing, health and biomedical science coursework — not clinical advice.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Engineering reports, technical writing, science and built environment project documentation.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Support for education reports, early childhood coursework and teaching-related assignments.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Hospitality, tourism and events management reports and case studies.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Academic support for law and criminal justice coursework — not legal advice.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700">
              <h3 className="font-bold mb-2 flex items-center gap-2"><Wrench className="w-5 h-5 text-indigo-600" />VU TAFE</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">Support for written TAFE assessments and reports — not a substitute for practical competency assessment.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">Support is delivered online regardless of your VU campus, or if you study through VU Online.</p>
