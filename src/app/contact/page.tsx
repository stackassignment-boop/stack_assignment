      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md text-center">
            ...
            <h3 className="font-bold text-lg mb-2 text-slate-900 dark:text-white">Email Us</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300">stackassignment@gmail.com</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Response within 24 hours</p>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md text-center">
            <Phone className="w-10 h-10 text-indigo-600 dark:text-indigo-400 mx-auto mb-3" />
            <h3 className="font-bold text-lg mb-2 text-slate-900 dark:text-white">Phone / WhatsApp</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300">+91-99073-00710</p>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md text-center">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300">Within 30 minutes</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">For urgent queries</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-8 md:p-10 rounded-2xl shadow-lg">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-2 text-slate-900 dark:text-white">Send Us a Message</h2>
            <p className="text-slate-600 dark:text-slate-400">Fill out the form below and we'll get back to you shortly</p>
          </div>
          ...
          <form className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-3 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full px-4 py-3 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition resize-none"
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-8 py-4 bg-yellow-400 hover:bg-yellow-300 text-slate-950 font-semibold rounded-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="mt-16">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-2 text-slate-900 dark:text-white">Frequently Asked Questions</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <details
                key={index}
                className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 group"
              >
                <summary className="px-6 py-4 cursor-pointer font-semibold text-slate-900 dark:text-white flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-700 transition">
                  {faq.q}
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-slate-950 rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <a
            href="/pricing"
            className="inline-block bg-white text-indigo-600 hover:bg-slate-100 px-10 py-4 rounded-xl text-lg font-bold transition shadow-lg hover:shadow-xl"
          >
            Get a Free Quote
          </a>
        </div>
