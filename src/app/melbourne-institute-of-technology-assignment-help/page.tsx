      ...
      <section className="stack-regional-hero relative text-white py-24 md:py-36 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Link
              href="/samples"
              className="border-2 border-white/70 hover:bg-white/10 px-10 py-4 rounded-xl text-lg font-semibold transition min-w-[15rem]"
            >
              View Sample Work
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-slate-800 dark:to-slate-800/50 rounded-2xl p-8 border border-indigo-100 dark:border-slate-700">
              ...
              <ul className="grid grid-cols-1 gap-2.5">
                {courseAreas.map((c) => (
                  <li key={c} className="flex items-center gap-2 text-slate-700 dark:text-slate-300 text-sm">
