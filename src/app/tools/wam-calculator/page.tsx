...
export default function WamCalculatorPage() {
  // `faqHeading={false}` keeps the FAQPage schema while suppressing the shell's
  // own FAQ band: this page lays the same questions out as cards inside the
  // guide, and rendering both would duplicate every answer on the page.
  return (
    <ToolPageShell
      url={url}
      ...
      intro={
        <>
          Work out your Weighted Average Mark the way Australian universities do &mdash; weighted by
          credit points, with failed units counted. Convert it to a 7-point GPA, check your
