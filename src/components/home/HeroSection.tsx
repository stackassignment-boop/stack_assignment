        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.08fr_.92fr]">
          <div>
            ...
            <h1 className="max-w-4xl text-4xl font-black tracking-tight sm:text-5xl md:text-6xl lg:text-[4.25rem] lg:leading-[1.02]">
              ...
              <span className="block bg-gradient-to-r from-yellow-300 via-indigo-200 to-purple-300 bg-clip-text text-transparent">Built for your university.</span>
            </h1>
            ...
            <div className="mt-8 grid max-w-2xl gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={title} className="flex gap-3 rounded-2xl border border-white/10 bg-white/[0.055] p-4 backdrop-blur-sm">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-indigo-300" />
                  <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button onClick={startRequest} className="h-14 rounded-2xl bg-yellow-400 px-7 text-base font-extrabold text-slate-950 shadow-xl shadow-yellow-500/20 hover:bg-yellow-300">
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-slate-300">
              <span className="inline-flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-indigo-300" /> Confidential</span>
              <span className="inline-flex items-center gap-2"><BookOpenCheck className="h-4 w-4 text-indigo-300" /> APA 7 · Harvard · AGLC4 · Vancouver</span>
              <span className="inline-flex items-center gap-2"><Clock3 className="h-4 w-4 text-indigo-300" /> 24/7 enquiries</span>
            </div>
          </div>

          <div className="relative mx-auto w-full max-w-xl">
            <div className="absolute -inset-1 rounded-[2rem] bg-gradient-to-r from-indigo-300/40 via-indigo-300/20 to-indigo-400/40 blur-xl" />
            <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-white/[0.96] p-5 text-slate-900 shadow-2xl sm:p-7">
              <div className="mb-5 flex items-start justify-between gap-4">
                ...
                <div className="hidden h-11 w-11 items-center justify-center rounded-2xl bg-indigo-50 sm:flex">
