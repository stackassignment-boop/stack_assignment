  ...
  return (
    <main className="flex-grow">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        {/* Intro Card */}
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 p-8 rounded-2xl shadow-lg border border-indigo-200 dark:border-indigo-900 mb-12 flex items-start gap-5">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow border-l-4 border-indigo-600">
