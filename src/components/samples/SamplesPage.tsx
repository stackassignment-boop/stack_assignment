...
import { FileText, Download, BookOpen, GraduationCap, FileCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Download our sample papers to see the quality of work we deliver
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            {samples.map((sample, index) => (
              ...
              >
                ...
                <div
                  className={`h-44 bg-gradient-to-br ${gradients[index % gradients.length]} flex flex-col items-center justify-center text-white p-6 text-center`}
                >
