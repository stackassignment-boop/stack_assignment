  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col m-4">
        ...
        >
          {loading && (
            <div className="flex items-center justify-center h-64">
              ...
              <span className="ml-4 text-slate-600 dark:text-slate-400">Loading preview...</span>
            </div>
          )}
        ...
        {/* Footer */}
        <div className="flex items-center justify-center py-3 px-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-xs text-slate-600 dark:text-slate-400 shrink-0">
          {error ? (
